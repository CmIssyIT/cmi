...
public class EnsTAnneeScolaire implements Serializable {

    private static final long serialVersionUID = -1265674566;

    private final Integer   idAnnee;
    private final String    libelle;
    private final Timestamp dateDebut;
    private final Timestamp dateFin;
    private final Timestamp dernierUtilisateur;

    public EnsTAnneeScolaire(EnsTAnneeScolaire value) {
        this.idAnnee = value.idAnnee;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final EnsTAnneeScolaire other = (EnsTAnneeScolaire) obj;
        if (idAnnee == null) {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.idAnnee == null) ? 0 : this.idAnnee.hashCode());
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("EnsTAnneeScolaire (");
